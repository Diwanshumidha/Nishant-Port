...
<div className=" container mx-auto px-9  py-9 flex flex-col gap-4">
        ...
        <p data-aos="fade-in" className=" text-[#141414] font-medium md:text-0" data-aos-duration="900" data-aos-delay="300">An exuberant learner with a proactive approach. Effective team player with excellent analytical skills and the important ability to think critically and solve complex problems.I have a good command over Word, Excel, PowerPoint, Access etc. I believe in the uniqueness of executing tasks which is the core competence of today's world. I love discovering new things or tools every day.I am eager to learn more about the intersection of technology and finance, and to explore how I can contribute to this exciting area. I have excellent time management skills and am good observant. If I do not know something I will learn it.</p>
        <div>
